...
@WebMvcTest(value = AxeService.class, secure = false)
@ContextConfiguration(classes = {Application.class})
@PrepareForTest(AxeCRUD.class)
@PowerMockRunnerDelegate(SpringRunner.class)
public class AxeServiceTest {
    ...
    public void getAllAxe() throws Exception {
        ...
        PowerMockito.mockStatic(AxeCRUD.class);
    ...
    public void create() throws Exception{
        ...
        PowerMockito.mockStatic(AxeCRUD.class);
        Mockito.
                when(AxeCRUD.create(axe)).thenReturn(true);
    }
    ...
    public void delete() throws Exception{
        ...
        PowerMockito.mockStatic(AxeCRUD.class);
        Mockito.
                when(AxeCRUD.delete(axe)).thenReturn(true);
    }
    ...
    public void update() throws Exception{
        ...
        PowerMockito.mockStatic(AxeCRUD.class);
        Mockito.
                when(AxeCRUD.update(axe)).thenReturn(true);
    }
