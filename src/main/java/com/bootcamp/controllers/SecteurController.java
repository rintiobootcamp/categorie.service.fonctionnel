...
//    local.public ResponseEntity<SecteurWs> create(@RequestBody @Valid Secteur Secteur) {
//
...
//    local.public ResponseEntity<SecteurWs> update(@RequestBody @Valid Secteur Secteur) {
//
//        SecteurWs SecteurWs = new SecteurWs();
//        HttpStatus httpStatus = null;
//
...
//    local.public ResponseEntity<SecteurWs> delete(@PathVariable(name = "id") int id) {
//
//        SecteurWs SecteurWs = new SecteurWs();
//        HttpStatus httpStatus = null;
//
...
//    local.public ResponseEntity<SecteurWs> read(@PathVariable(name = "id") int id) {
//
//        SecteurWs SecteurWs = new SecteurWs();
//        HttpStatus httpStatus = null;
//
...
//    @ApiVersions({"1.0"})
//    @ApiOperation(value = "Read a Secteur", notes = "Read a Secteur")
//    local.public ResponseEntity<SecteurWss> read() {
//
